...
contract FundMeTest is Test {
    ...
    function testCanWithdrawFromMultipleFunders() public funded {
        //Arrange Setup
        uint160 numberOfFunders = 10; // We can no longer cast from address to uin256
        ...
        for (uint160 i = startingFunderIndex; i < numberOfFunders; i++) {
            ...
            // Sometimes the zzero address reverts and doesn't let us do stuff with it so we start from 1.
    ...
    function testCanWithdrawFromMultipleFundersCheaper() public funded {
        //Arrange Setup
        uint160 numberOfFunders = 10; // We can no longer cast from address to uin256
        uint160 startingFunderIndex = 1;
